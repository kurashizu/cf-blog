...
╚██████╔╝╚██████╔╝███████╗███████║   ██║   ██████╔╝╚██████╔╝╚██████╔╝██║  ██╗
 ╚═════╝  ╚═════╝ ╚══════╝╚══════╝   ╚═╝   ╚═════╝  ╚═════╝  ╚═════╝ ╚═╝  ╚═╝`}</pre>
		<div class="flex flex-wrap items-center gap-1.5 text-xs sm:text-sm shrink-0">
			<button onclick={() => handleCopy('krsz.dev@gmail.com')} class="border border-[#e06c75] px-2 py-0.5 rounded-xs text-[#e06c75] hover:bg-[#e06c75] hover:text-black cursor-pointer transition-colors">[krsz.dev@gmail.com]</button>
			<button onclick={() => handleCopy('admin@krsz.in')} class="border border-[#e06c75] px-2 py-0.5 rounded-xs text-[#e06c75] hover:bg-[#e06c75] hover:text-black cursor-pointer transition-colors">[admin@krsz.in]</button>
		</div>
	</div>

	<form onsubmit={handleSubmit} class="border border-white/10 p-4 bg-black/30 space-y-3.5 text-xs sm:text-sm rounded-xs">
		<div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
			<div class="space-y-1">
				<label class="block text-xs font-bold text-[#56b6c2]" for="gb-name">CALLSIGN / NAME</label>
				<div class="relative border border-white/20 focus-within:border-[#56b6c2] bg-black/60 px-3 py-2 rounded-xs flex items-center min-h-[40px]">
			...
			<div class="space-y-1">
				...
				<div class="relative border border-white/20 focus-within:border-[#e5c07b] bg-black/60 px-3 py-2 rounded-xs flex items-center min-h-[40px]">
		...
		<div class="space-y-1">
			...
			<div class="relative border border-white/20 focus-within:border-[#e06c75] bg-black/60 p-3 rounded-xs min-h-[80px]">
		...
		{#if gbStatus}
			<div class="border border-[#98c379] p-2.5 text-xs sm:text-sm font-bold text-[#98c379] bg-black/40 rounded-xs">{gbStatus}</div>
		{/if}
