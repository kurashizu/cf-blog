...
export const RLES = {
	...
	pulsar: {
		label: 'PULSAR',
		rle: '2b3o3b3o2b2$o4bobo4bo$o4bobo4bo$o4bobo4bo$2b3o3b3o2b2$2b3o3b3o$o4bobo4bo$o4bobo4bo$o4bobo4bo2$2b3o3b3o!'
	},
	...
	switchEngine: {
		label: 'SWITCH ENGINE',
		rle: '4b2o$4b2o2$2b5o$bo5bo$o3bobo$o3bobo$bo5bo$2b5o2$4b2o$4b2o!'
	},
	...
	gunSink: {
		label: 'GUN + SINK',
		rle: '24bo$22bobo$12b2o6b2o12b2o$11bo3bo4b2o12b2o$2o8bo5bo3b2o$2o8bo3bob2o4bobo$10bo5bo7bo$11bo3bo$12b2o22$38b2o$38bobo$40bo$40b2o!'
	}
};
...
export function decodeRLE(rle) {
	...
	for (const c of rle) {
		...
		if (c === 'b') x += n;
			...
			for (let k = 0; k < n; k++) cells.push([x++, y]);
		} else if (c === '$') {
			y += n;
			x = 0;
		} else if (c === '!') break;
 ...
 */
const NOTES = {
	block: 'lifelab.note.block',
	beehive: 'lifelab.note.beehive',
	loaf: 'lifelab.note.loaf',
	tub: 'lifelab.note.tub',
	boat: 'lifelab.note.boat',
	pond: 'lifelab.note.pond',
	eater: 'lifelab.note.eater',
	blinker: 'lifelab.note.blinker',
	toad: 'lifelab.note.toad',
	beacon: 'lifelab.note.beacon',
	clock: 'lifelab.note.clock',
	pulsar: 'lifelab.note.pulsar',
	figure8: 'lifelab.note.figure8',
	pentadec: 'lifelab.note.pentadec',
	glider: 'lifelab.note.glider',
	lwss: 'lifelab.note.lwss',
	mwss: 'lifelab.note.mwss',
	hwss: 'lifelab.note.hwss',
	flotilla: 'lifelab.note.flotilla',
	loafer: 'lifelab.note.loafer',
	copperhead: 'lifelab.note.copperhead',
	rpent: 'lifelab.note.rpent',
	acorn: 'lifelab.note.acorn',
	diehard: 'lifelab.note.diehard',
	bunnies: 'lifelab.note.bunnies',
	rabbits: 'lifelab.note.rabbits',
...
export const CATEGORIES = [
	{
		id: 'still',
		label: 'lifelab.cat.still.label',
		hint: 'lifelab.cat.still.hint',
		of: ['block', 'beehive', 'loaf', 'tub', 'boat', 'pond', 'eater', 'eaters']
	},
	{
		id: 'osc',
		label: 'lifelab.cat.osc.label',
		hint: 'lifelab.cat.osc.hint',
		of: ['blinker', 'toad', 'beacon', 'clock', 'pulsar', 'figure8', 'pentadec', 'lowPeriod']
	},
	{
		id: 'ship',
		label: 'lifelab.cat.ship.label',
		hint: 'lifelab.cat.ship.hint',
		of: [
			'glider',
			'lwss',
			'mwss',
	...
	{
		id: 'meth',
		label: 'lifelab.cat.meth.label',
		hint: 'lifelab.cat.meth.hint',
		of: [
			'rpent',
			'acorn',
			'diehard',
	...
	{
		id: 'puff',
		label: 'lifelab.cat.puff.label',
		hint: 'lifelab.cat.puff.hint',
		of: ['switchEngine', 'pufferTrain', 'piFuse', 'linePuffer', 'puffer2c5', 'basicRakes']
	},
	{
		id: 'gun',
		label: 'lifelab.cat.gun.label',
		hint: 'lifelab.cat.gun.hint',
		of: ['gosperGun', 'p52gun', 'vacuum', 'mwssGun', 'loaferGun', 'p59gun']
	},
	{
		id: 'grow',
		label: 'lifelab.cat.grow.label',
		hint: 'lifelab.cat.grow.hint',
		of: ['spacefiller', 'quartermax', 'quad20', 'seBreeder', 'c4Breeder', 'rakeFactory', 'sawtooth']
	},
	{
		id: 'logic',
		label: 'lifelab.cat.logic.label',
		hint: 'lifelab.cat.logic.hint',
		of: [
			'annihilate',
			'sink',
			'gunSink',
	...
	{
		id: 'turing',
		label: 'lifelab.cat.turing.label',
		hint: 'lifelab.cat.turing.hint',
...
function loadCustom() {
	...
	try {
		...
		customList = Array.isArray(arr)
			? arr.filter((c) => c && typeof c.key === 'string' && typeof c.rle === 'string')
			: [];
	} catch {
		customList = [];
	}
...
function saveCustom() {
	try {
		localStorage.setItem(CUSTOM_KEY, JSON.stringify(customList || []));
	} catch {
 ...
 */
const EXT_NOTES = {
	blom: 'lifelab.ext.blom',
	iwona: 'lifelab.ext.iwona',
	justyna: 'lifelab.ext.justyna',
	lidka: 'lifelab.ext.lidka',
	m52513: 'lifelab.ext.m52513',
	pufferTrain: 'lifelab.ext.pufferTrain',
	piFuse: 'lifelab.ext.piFuse',
	linePuffer: 'lifelab.ext.linePuffer',
	puffer2c5: 'lifelab.ext.puffer2c5',
	basicRakes: 'lifelab.ext.basicRakes',
	p52gun: 'lifelab.ext.p52gun',
	vacuum: 'lifelab.ext.vacuum',
	mwssGun: 'lifelab.ext.mwssGun',
	loaferGun: 'lifelab.ext.loaferGun',
	p59gun: 'lifelab.ext.p59gun',
	spacefiller: 'lifelab.ext.spacefiller',
	quartermax: 'lifelab.ext.quartermax',
	quad20: 'lifelab.ext.quad20',
	seBreeder: 'lifelab.ext.seBreeder',
	c4Breeder: 'lifelab.ext.c4Breeder',
	rakeFactory: 'lifelab.ext.rakeFactory',
	sawtooth: 'lifelab.ext.sawtooth',
	advancer: 'lifelab.ext.advancer',
	heisenblinker: 'lifelab.ext.heisenblinker',
	heisenburpNat: 'lifelab.ext.heisenburpNat',
	heisenburp30: 'lifelab.ext.heisenburp30',
	heisenburp46: 'lifelab.ext.heisenburp46',
	stargate: 'lifelab.ext.stargate',
	racetrack: 'lifelab.ext.racetrack',
	hotel: 'lifelab.ext.hotel',
	reflectors: 'lifelab.ext.reflectors',
	fizzles: 'lifelab.ext.fizzles',
	turing: 'lifelab.ext.turing',
	chase: 'lifelab.ext.chase',
	unitCell: 'lifelab.ext.unitCell',
	orthoShips: 'lifelab.ext.orthoShips',
	diagShips: 'lifelab.ext.diagShips',
	corderships: 'lifelab.ext.corderships',
	lowPeriod: 'lifelab.ext.lowPeriod',
	eaters: 'lifelab.ext.eaters'
};
...
export function patternMeta(key) {
	if (key in RLES)
		return { label: RLES[/** @type {keyof typeof RLES} */ (key)].label, note: tr(NOTES[key]) };
	if (key in EXT) {
		const e = EXT[key];
		return { ...e, note: EXT_NOTES[key] ? tr(EXT_NOTES[key]) : e.note };
	}
...
export function pattern(name) {
	if (!cache[name]) {
		const src =
			name in RLES
				? RLES[/** @type {keyof typeof RLES} */ (name)]
				: name in EXT
					? EXT[name]
...
export function kindOf(name) {
	...
	const shape = (g) => {
		...
		let k = '';
		for (let y = y0; y <= y1; y++) {
			for (let x = x0; x <= x1; x++) k += g[y * W + x] ? '1' : '0';
			k += '/';
		}
		return { k, x0, y0 };
	};
