...
export default {
	en: {
		...
		'synthPatch.mod.when': 'Asks something each time a note starts. Cable ENTRY TRIG in, and DO out to an ACT.',
		...
		'synth.preset.voicePolyHint': 'POLY — notes overlap, the way a keyboard does',
		'synth.preset.voiceMonoHint': 'MONO — a new note takes the voice and the old tail stops at once, the way a bass line behaves',
		'synth.preset.voiceLegatoHint': 'LEGATO — a new note slides into the old one rather than restriking it. Set GLIDE on rack 2 to carry the pitch across.',
		'synth.preset.muteGroupHint': 'Mute group — keys sharing a number cut each other off, the way a closed hi-hat stops an open one',
		'synth.preset.muteGroupNoneHint': 'No group — this key rings alongside everything else',
		'synth.preset.muteGroupNHint': 'Group {n} — this key and every other key in group {n} silence one another',
	...
	'zh-CN': {
		...
		'synthPatch.mod.when': '每次有音符开始时做一次判断。把 ENTRY 的 TRIG 接进来，DO 接到 ACT。',
		...
		'synth.preset.voicePolyHint': 'POLY — 多个音同时存在，像键盘那样',
		'synth.preset.voiceMonoHint': 'MONO — 新音接管发声，旧音尾立刻中断，像贝斯线那样',
		'synth.preset.voiceLegatoHint': 'LEGATO — 新音滑入旧音而不重新击发。在机架 2 设置 GLIDE 让音高滑过去。',
		'synth.preset.muteGroupHint': '互斥组 — 同组的按键互相掐断，就像闭镲会切掉开镲',
		'synth.preset.muteGroupNoneHint': '无分组 — 这个键与其他所有键各自发声',
		'synth.preset.muteGroupNHint': '第 {n} 组 — 这个键与第 {n} 组的其他键互相静音',
	...
	'zh-TW': {
		...
		'synthPatch.mod.when': '每次有音符開始時做一次判斷。把 ENTRY 的 TRIG 接進來，DO 接到 ACT。',
		...
		'synth.preset.voicePolyHint': 'POLY — 多個音同時存在，像鍵盤那樣',
		'synth.preset.voiceMonoHint': 'MONO — 新音接管發聲，舊音尾立刻中斷，像貝斯線那樣',
		'synth.preset.voiceLegatoHint': 'LEGATO — 新音滑入舊音而不重新擊發。在機架 2 設定 GLIDE 讓音高滑過去。',
		'synth.preset.muteGroupHint': '互斥組 — 同組的按鍵互相掐斷，就像閉鈸會切掉開鈸',
		'synth.preset.muteGroupNoneHint': '無分組 — 這個鍵與其他所有鍵各自發聲',
		'synth.preset.muteGroupNHint': '第 {n} 組 — 這個鍵與第 {n} 組的其他鍵互相靜音',
	...
	ja: {
		...
		'synthPatch.mod.when': 'ノートが鳴るたびに条件を判定します。ENTRY の TRIG を入力し、DO を ACT へつなぎます。',
		...
		'synth.preset.voicePolyHint': 'POLY — 鍵盤のように音が重なります',
		'synth.preset.voiceMonoHint': 'MONO — 新しい音が発音を引き継ぎ、前の音の余韻はすぐ止まります。ベースラインの挙動です',
		'synth.preset.voiceLegatoHint': 'LEGATO — 新しい音が前の音に滑り込み、打ち直しません。ラック2の GLIDE でピッチを繋げます。',
		'synth.preset.muteGroupHint': 'ミュートグループ — 同じ番号のキーは互いを止めます。クローズドハイハットがオープンを止めるのと同じです',
		'synth.preset.muteGroupNoneHint': 'グループなし — このキーは他のどれとも独立して鳴ります',
		'synth.preset.muteGroupNHint': 'グループ {n} — このキーとグループ {n} の他のキーは互いを消音します',
	...
	ko: {
		...
		'synthPatch.mod.when': '음이 시작될 때마다 조건을 확인합니다. ENTRY의 TRIG를 연결하고 DO를 ACT로 보내세요.',
		...
		'synth.preset.voicePolyHint': 'POLY — 건반처럼 음이 겹칩니다',
		'synth.preset.voiceMonoHint': 'MONO — 새 음이 발음을 가져가고 이전 음의 꼬리는 즉시 멈춥니다. 베이스 라인의 방식입니다',
		'synth.preset.voiceLegatoHint': 'LEGATO — 새 음이 이전 음으로 미끄러져 들어가며 다시 치지 않습니다. 랙 2의 GLIDE로 음정을 이어 주세요.',
		'synth.preset.muteGroupHint': '뮤트 그룹 — 같은 번호의 건반은 서로를 끊습니다. 클로즈드 하이햇이 오픈을 멈추는 것과 같습니다',
		'synth.preset.muteGroupNoneHint': '그룹 없음 — 이 건반은 다른 모든 건반과 따로 울립니다',
		'synth.preset.muteGroupNHint': '그룹 {n} — 이 건반과 그룹 {n}의 다른 건반은 서로를 음소거합니다',
