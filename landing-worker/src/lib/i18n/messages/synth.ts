...
export default {
	en: {
		...
		'synthPatch.groupHint': 'Draw a box around the selection (Ctrl+G)',
		'synthPatch.ungroupHint': 'Remove the box, keep the modules (Ctrl+Shift+G)',
		'synthPatch.ungroupNothing': 'Select a group, or a node inside one',
		'synthPatch.resizeHint': 'Drag to resize; what the box covers is what it owns',
		'synthPatch.savePrefabHint': 'Save the selection to the prefab shelf',
		'synthPatch.macroHint':
			'Collapse the selection into one macro card; its edge cables become sockets',
		'synthPatch.expandHint': "Put the selected macro's insides back on the canvas",
		'synthPatch.expandNothing': 'Select a macro card to expand',
		'synthPatch.macroExec':
			'A macro holds signal and values, not KEY-EVENT, OUT or the logic chain',
		'synthPatch.macroEmpty': 'Select the nodes to collapse first',
		'synthPatch.macroTop': 'PATCH',
		'synthPatch.macroTopHint': "Back to the track's own patch",
		'synthPatch.macroBack': 'BACK',
		'synthPatch.macroBackHint': 'Up one level',
		'synthPatch.macroRenameHint': 'Rename this macro (4 characters)',
		'synthPatch.macroInsideNote': 'editing every instance',
		'synthPatch.mod.macro':
			'A macro: nodes collapsed into one card. Double-click to open; every instance shares its insides and differs only by what is cabled in.',
		'synthPatch.prefabsTitle': 'PREFABS',
		'synthPatch.prefabDropHint': 'Drag onto the canvas, or click to place',
		'synthPatch.prefabDeleteHint': 'Delete this prefab',
		'synthPatch.prefabNamePrompt': 'Name this prefab',
		'synthPatch.groupNamePrompt': 'Name this group',
		'synthPatch.groupNeedsTwo': 'Select at least two modules to group',
		'synthPatch.prefabSaved': 'Saved as a prefab',
		'synthPrefab.note.lfo': 'An oscillator at a low frequency, scaled into a control range.',
		'synthPrefab.note.comb': 'A delay fed back into itself, for a ringing, pitched tail.',
		'synthPrefab.note.voice': 'A subtractive voice: oscillator, filter, and an envelope on each.',
		...
		'synthPatch.mod.in':
			'The note itself. THEN runs the patch, PITCH VEL NOTE GATE say what was played.',
		...
		'synthPatch.mod.topitch': 'Reads a frequency back as a pitch, exactly. A4 sets the reference.',
		'synthPatch.mod.trsp':
		...
		'synthPatch.mod.note': 'A comment. Says something the patch cannot; changes nothing it does.',
		'synthPatch.mod.tocv':
	...
	'zh-CN': {
		...
		'synthPatch.groupHint': '为所选画一个框（Ctrl+G）',
		'synthPatch.ungroupHint': '移除框，保留模块（Ctrl+Shift+G）',
		'synthPatch.ungroupNothing': '先选中一个组，或组里的任意节点',
		'synthPatch.resizeHint': '拖动调整大小；框住哪些就拥有哪些',
		'synthPatch.savePrefabHint': '将所选保存到预制件架',
		'synthPatch.macroHint': '把所选折叠成一个宏卡片；跨越边界的连线变成它的端口',
		'synthPatch.expandHint': '把所选宏的内部放回画布',
		'synthPatch.expandNothing': '先选中要展开的宏卡片',
		'synthPatch.macroExec': '宏只能装信号和数值，不能装 KEY-EVENT、OUT 或逻辑链',
		'synthPatch.macroEmpty': '先选中要折叠的节点',
		'synthPatch.macroTop': 'PATCH',
		'synthPatch.macroTopHint': '回到轨道自己的音色图',
		'synthPatch.macroBack': 'BACK',
		'synthPatch.macroBackHint': '返回上一层',
		'synthPatch.macroRenameHint': '重命名这个宏（4 个字符）',
		'synthPatch.macroInsideNote': '正在编辑所有实例',
		'synthPatch.mod.macro':
			'宏：折叠成一个卡片的一组节点。双击打开；所有实例共用内部，只以接进来的连线区分。',
		'synthPatch.prefabsTitle': '预制件',
		'synthPatch.prefabDropHint': '拖到画布上，或点击放置',
		'synthPatch.prefabDeleteHint': '删除此预制件',
		'synthPatch.prefabNamePrompt': '为此预制件命名',
		'synthPatch.groupNamePrompt': '为此组命名',
		'synthPatch.groupNeedsTwo': '至少选择两个模块才能分组',
		'synthPatch.prefabSaved': '已保存为预制件',
		'synthPrefab.note.lfo': '低频振荡器，缩放到控制范围。',
		'synthPrefab.note.comb': '延迟反馈到自身，产生带音高的振铃尾音。',
		'synthPrefab.note.voice': '减法合成声部：振荡器、滤波器，各配一个包络。',
		'synthPrefab.note.wide': '将一侧延迟几毫秒，把单声道变成立体声。',
		'synthPrefab.note.vib': '颤音：用一个振荡器改变另一个的频率。',
		'synthPrefab.note.duck': '侧链闪避：一个信号把另一个压下去。',
		'synthPrefab.note.pingpong': '两条延迟交叉反馈，重复声左右弹跳。',
		...
		'synthPatch.sharedActivation': '这个 OUT 已经被另一路 THEN/REL 驱动，请用另一个 OUT',
		'synthPatch.keyEventCapped': '只能有一个 KEY-EVENT，先删除已有的那个',
		...
		'synthPatch.mod.out': '把这张图送进主总线。没有连到这里的东西都不会发声。',
		'synthPatch.mod.tofreq': '把音高转换成它所对应的频率。A4 设定基准音。',
		'synthPatch.mod.topitch': '把频率精确读回成音高。A4 设定基准音。',
		...
		'synthPatch.mod.add': 'A 加 B。没接线的一路读作 0；要固定一路就接 CONST。',
		'synthPatch.mod.mul': 'A 乘 B。没接线的一路读作 1；要固定一路就接 CONST。',
		'synthPatch.mod.sub': 'A 减 B。没接线的一路读作 0；要固定一路就接 CONST。',
		'synthPatch.mod.div': 'A 除以 B。B 没接线时读作 1；B 为 0 时同样读作恒等值，不会变成无穷大。',
		'synthPatch.mod.mod': 'A 对 B 取余。B 没接线时读作 0，即恒等——完全不取余。',
		'synthPatch.mod.remap':
		...
		'synthPatch.mod.loud': '这一点有多大：音频按 dB，调制值直接读数，对照 LO..HI。',
		...
		'synthPatch.mod.note': '注释标签。只说明，不影响声音。',
	...
	'zh-TW': {
		...
		'synthPatch.groupHint': '為所選畫一個框（Ctrl+G）',
		'synthPatch.ungroupHint': '移除框，保留模組（Ctrl+Shift+G）',
		'synthPatch.ungroupNothing': '先選取一個群組，或群組內的任一節點',
		'synthPatch.resizeHint': '拖曳調整大小；框住哪些就擁有哪些',
		'synthPatch.savePrefabHint': '將所選儲存到預製件架',
		'synthPatch.macroHint': '把所選折疊成一個巨集卡片；跨越邊界的連線變成它的端口',
		'synthPatch.expandHint': '把所選巨集的內部放回畫布',
		'synthPatch.expandNothing': '先選取要展開的巨集卡片',
		'synthPatch.macroExec': '巨集只能裝訊號和數值，不能裝 KEY-EVENT、OUT 或邏輯鏈',
		'synthPatch.macroEmpty': '先選取要折疊的節點',
		'synthPatch.macroTop': 'PATCH',
		'synthPatch.macroTopHint': '回到軌道自己的音色圖',
		'synthPatch.macroBack': 'BACK',
		'synthPatch.macroBackHint': '返回上一層',
		'synthPatch.macroRenameHint': '重新命名這個巨集（4 個字元）',
		'synthPatch.macroInsideNote': '正在編輯所有實例',
		'synthPatch.mod.macro':
			'巨集：折疊成一個卡片的一組節點。雙擊開啟；所有實例共用內部，只以接進來的連線區分。',
		'synthPatch.prefabsTitle': '預製件',
		'synthPatch.prefabDropHint': '拖到畫布上，或點擊放置',
		'synthPatch.prefabDeleteHint': '刪除此預製件',
		'synthPatch.prefabNamePrompt': '為此預製件命名',
		'synthPatch.groupNamePrompt': '為此群組命名',
		'synthPatch.groupNeedsTwo': '至少選擇兩個模組才能分組',
		'synthPatch.prefabSaved': '已儲存為預製件',
		'synthPrefab.note.lfo': '低頻振盪器，縮放到控制範圍。',
		'synthPrefab.note.comb': '延遲回授到自身，產生帶音高的殘響尾音。',
		'synthPrefab.note.voice': '減法合成聲部：振盪器、濾波器，各配一個包絡。',
		'synthPrefab.note.wide': '將一側延遲幾毫秒，把單聲道變成立體聲。',
		'synthPrefab.note.vib': '顫音：用一個振盪器改變另一個的頻率。',
		'synthPrefab.note.duck': '側鏈閃避：一個訊號把另一個壓下去。',
		'synthPrefab.note.pingpong': '兩條延遲交叉回授，重複聲左右彈跳。',
		...
		'synthPatch.sharedActivation': '這個 OUT 已經被另一路 THEN/REL 驅動，請用另一個 OUT',
		'synthPatch.keyEventCapped': '只能有一個 KEY-EVENT，請先刪除已有的那個',
		...
		'synthPatch.mod.out': '把這張圖送進主匯流排。沒有連到這裡的東西都不會發聲。',
		'synthPatch.mod.tofreq': '把音高轉換成它所對應的頻率。A4 設定基準音。',
		'synthPatch.mod.topitch': '把頻率精確讀回成音高。A4 設定基準音。',
		...
		'synthPatch.mod.add': 'A 加 B。沒接線的一路讀作 0；要固定一路就接 CONST。',
		'synthPatch.mod.mul': 'A 乘 B。沒接線的一路讀作 1；要固定一路就接 CONST。',
		'synthPatch.mod.sub': 'A 減 B。沒接線的一路讀作 0；要固定一路就接 CONST。',
		'synthPatch.mod.div': 'A 除以 B。B 沒接線時讀作 1；B 為 0 時同樣讀作恆等值，不會變成無窮大。',
		'synthPatch.mod.mod': 'A 對 B 取餘。B 沒接線時讀作 0，即恆等——完全不取餘。',
		'synthPatch.mod.remap':
		...
		'synthPatch.mod.loud': '這一點有多大：音訊按 dB，調制值直接讀數，對照 LO..HI。',
		...
		'synthPatch.mod.note': '註釋標籤。只說明，不影響聲音。',
	...
	ja: {
		...
		'synthPatch.groupHint': '選択を枠で囲む（Ctrl+G）',
		'synthPatch.ungroupHint': '枠だけ外す（モジュールは残る／Ctrl+Shift+G）',
		'synthPatch.ungroupNothing': 'グループか、その中のノードを選んでください',
		'synthPatch.resizeHint': 'ドラッグでサイズ変更。囲んだものが中身になる',
		'synthPatch.savePrefabHint': '選択をプリファブ棚に保存',
		'synthPatch.macroHint':
			'選択を 1 枚のマクロカードにまとめます。境界を越える配線がソケットになります',
		'synthPatch.expandHint': '選択したマクロの中身をキャンバスに戻します',
		'synthPatch.expandNothing': '展開するマクロカードを選択してください',
		'synthPatch.macroExec':
			'マクロに入るのは信号と値だけです。KEY-EVENT、OUT、ロジックは入りません',
		'synthPatch.macroEmpty': 'まとめるノードを先に選択してください',
		'synthPatch.macroTop': 'PATCH',
		'synthPatch.macroTopHint': 'トラック自身のパッチに戻る',
		'synthPatch.macroBack': 'BACK',
		'synthPatch.macroBackHint': '1 つ上へ',
		'synthPatch.macroRenameHint': 'このマクロの名前を変更（4 文字）',
		'synthPatch.macroInsideNote': 'すべてのインスタンスを編集中',
		'synthPatch.mod.macro':
			'マクロ：1 枚にまとめたノード群。ダブルクリックで開きます。全インスタンスが中身を共有し、配線だけが異なります。',
		'synthPatch.prefabsTitle': 'プリファブ',
		'synthPatch.prefabDropHint': 'キャンバスへドラッグ、またはクリックで配置',
		'synthPatch.prefabDeleteHint': 'このプリファブを削除',
		'synthPatch.prefabNamePrompt': 'プリファブの名前',
		'synthPatch.groupNamePrompt': 'グループの名前',
		'synthPatch.groupNeedsTwo': 'グループ化には2つ以上のモジュールが必要です',
		'synthPatch.prefabSaved': 'プリファブとして保存しました',
		'synthPrefab.note.lfo': '低い周波数の発振器。コントロールの範囲に合わせます。',
		'synthPrefab.note.comb': 'ディレイを自身へ戻したもの。音程を持った余韻が残ります。',
		'synthPrefab.note.voice': '減算合成のボイス。発振器、フィルター、それぞれにエンベロープ。',
		'synthPrefab.note.wide': '片側を数ミリ秒遅らせてモノラルをステレオにします。',
		'synthPrefab.note.vib': 'ビブラート。発振器で別の発振器の周波数を揺らします。',
		'synthPrefab.note.duck': 'サイドチェイン。片方の音がもう片方を押し下げます。',
		'synthPrefab.note.pingpong': '2本のディレイをたすき掛けに戻し、左右へ跳ね返らせます。',
		...
		'synthPatch.mod.in':
			'ノートそのもの。THEN がパッチを実行し、PITCH VEL NOTE GATE が演奏内容を伝えます。',
		'synthPatch.mod.out': 'パッチをマスターバスへ送ります。ここに届かないものは鳴りません。',
		'synthPatch.mod.tofreq': '音高をそれが指す周波数へ変換します。A4 が基準です。',
		'synthPatch.mod.topitch': '周波数を音高として正確に読み戻します。A4 が基準です。',
		'synthPatch.mod.trsp':
	...
	ko: {
		...
		'synthPatch.groupHint': '선택 주위에 상자 그리기(Ctrl+G)',
		'synthPatch.ungroupHint': '상자만 제거, 모듈은 유지(Ctrl+Shift+G)',
		'synthPatch.ungroupNothing': '그룹이나 그 안의 노드를 선택하세요',
		'synthPatch.resizeHint': '드래그로 크기 조절; 상자가 덮은 것이 그 내용',
		'synthPatch.savePrefabHint': '선택을 프리팹 선반에 저장',
		'synthPatch.macroHint':
			'선택을 매크로 카드 하나로 접습니다. 경계를 넘는 케이블이 소켓이 됩니다',
		'synthPatch.expandHint': '선택한 매크로의 내부를 캔버스에 되돌립니다',
		'synthPatch.expandNothing': '펼칠 매크로 카드를 선택하세요',
		'synthPatch.macroExec':
			'매크로에는 신호와 값만 들어갑니다. KEY-EVENT, OUT, 로직 체인은 안 됩니다',
		'synthPatch.macroEmpty': '접을 노드를 먼저 선택하세요',
		'synthPatch.macroTop': 'PATCH',
		'synthPatch.macroTopHint': '트랙 자신의 패치로 돌아가기',
		'synthPatch.macroBack': 'BACK',
		'synthPatch.macroBackHint': '한 단계 위로',
		'synthPatch.macroRenameHint': '이 매크로 이름 바꾸기 (4자)',
		'synthPatch.macroInsideNote': '모든 인스턴스를 편집 중',
		'synthPatch.mod.macro':
			'매크로: 카드 하나로 접은 노드 묶음. 더블클릭으로 엽니다. 모든 인스턴스가 내부를 공유하고 연결된 케이블로만 달라집니다.',
		'synthPatch.prefabsTitle': '프리팹',
		'synthPatch.prefabDropHint': '캔버스로 드래그하거나 클릭해 배치',
		'synthPatch.prefabDeleteHint': '이 프리팹 삭제',
		'synthPatch.prefabNamePrompt': '프리팹 이름',
		'synthPatch.groupNamePrompt': '그룹 이름',
		'synthPatch.groupNeedsTwo': '그룹을 만들려면 모듈을 두 개 이상 선택하세요',
		'synthPatch.prefabSaved': '프리팹으로 저장했습니다',
		'synthPrefab.note.lfo': '낮은 주파수의 오실레이터. 컨트롤 범위로 맞춥니다.',
		'synthPrefab.note.comb': '딜레이를 자신에게 되먹여 음정 있는 울림을 남깁니다.',
		'synthPrefab.note.voice': '감산 합성 보이스: 오실레이터, 필터, 각각의 엔벨로프.',
		'synthPrefab.note.wide': '한쪽을 몇 밀리초 늦춰 모노를 스테레오로 만듭니다.',
		'synthPrefab.note.vib': '비브라토: 오실레이터로 다른 오실레이터의 주파수를 흔듭니다.',
		'synthPrefab.note.duck': '사이드체인 더킹: 한 신호가 다른 신호를 눌러 줍니다.',
		'synthPrefab.note.pingpong': '두 딜레이를 엇갈려 되먹여 좌우로 튀게 합니다.',
