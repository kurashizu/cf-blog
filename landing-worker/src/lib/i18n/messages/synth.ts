...
export default {
	en: {
		...
		'synthPatch.mod.in': 'The voice from racks 1-7 arriving in the patch. Where the signal enters.',
		'synthPatch.mod.out': 'Where the patch leaves, with its own level and pan. Anything not reaching it is silent.',
	...
	'zh-CN': {
		...
		'synthPatch.mod.in': '来自 1-7 号机架的声音，信号从这里进入这张连接图。',
	...
	'zh-TW': {
		...
		'synthPatch.mod.in': '來自 1-7 號機架的聲音，訊號從這裡進入這張連接圖。',
	...
	ja: {
		...
		'synthPatch.mod.in': 'ラック1〜7からの音がパッチに入る場所です。',
	...
	ko: {
		...
		'synthPatch.mod.in': '랙 1-7에서 오는 소리가 패치로 들어오는 지점입니다.',
