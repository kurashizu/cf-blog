...
export default {
	en: {
		...
		'synth.transport.lenInputAria': 'Pattern length in pages',
		...
		'synth.transport.pageInputAria': 'Page number, of {total}',
	...
	'zh-CN': {
		...
		'synth.transport.lenInputAria': '图形长度（页）',
		...
		'synth.transport.pageInputAria': '页码，共 {total} 页',
	...
	'zh-TW': {
		...
		'synth.transport.lenInputAria': '圖形長度（頁）',
		...
		'synth.transport.pageInputAria': '頁碼，共 {total} 頁',
	...
	ja: {
		...
		'synth.transport.lenInputAria': 'パターン長（ページ）',
		...
		'synth.transport.pageInputAria': 'ページ番号（全 {total} ページ）',
	...
	ko: {
		...
		'synth.transport.lenInputAria': '패턴 길이(페이지)',
		...
		'synth.transport.pageInputAria': '페이지 번호(전체 {total}페이지)',
