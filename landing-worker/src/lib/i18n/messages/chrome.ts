...
export default {
	en: {
		...
		'chrome.console.scrollbackLabel': 'Console output',
		'chrome.console.inputLabel': 'Console command input',
		...
		'chrome.console.help.dialogs': 'open the config / credits / privacy dialogs',
		...
		'chrome.console.run.openedSettings': 'Opened config.',
		...
		'chrome.hotkeys.synthTransportNote': 'Active on view 2 whenever no text field, menu or config panel has focus',
	...
	'zh-CN': {
		...
		'chrome.console.scrollbackLabel': '控制台输出',
		'chrome.console.inputLabel': '控制台命令输入框',
		...
		'chrome.console.help.dialogs': '打开配置 / 鸣谢 / 隐私对话框',
		...
		'chrome.console.usage.settings': '打开全局配置面板。',
		...
		'chrome.console.run.openedSettings': '已打开配置。',
		...
		'chrome.hotkeys.synthTransportNote': '在视图 2 上，只要没有文本框、菜单或配置面板获得焦点即生效',
		...
		'chrome.tabbar.settingsTitle': '全局配置 — 声音，以及清除本站在此浏览器中存储的任何内容',
	...
	'zh-TW': {
		...
		'chrome.console.scrollbackLabel': '主控台輸出',
		'chrome.console.inputLabel': '主控台指令輸入欄',
		...
		'chrome.console.help.dialogs': '開啟配置 / credits / 隱私權對話框',
		...
		'chrome.console.usage.settings': '開啟全域配置面板。',
		...
		'chrome.console.run.openedSettings': '已開啟配置。',
		...
		'chrome.hotkeys.synthTransport': 'SYNTH — 播放控制',
		'chrome.hotkeys.synthTransportNote': '在畫面 2 上，只要沒有文字欄位、選單或配置面板取得焦點即生效',
		...
		'chrome.tabbar.settingsTitle': '全域配置 — 聲音，以及清除本站在此瀏覽器中儲存的任何內容',
	...
	ja: {
		...
		'chrome.console.scrollbackLabel': 'コンソール出力',
		'chrome.console.inputLabel': 'コンソールコマンド入力',
		...
		'chrome.console.help.dialogs': '構成 / credits / プライバシーのダイアログを開く',
		...
		'chrome.console.run.openedSettings': '構成を開きました。',
		...
		'chrome.hotkeys.synthTransportNote': 'ビュー 2 で、テキスト欄・メニュー・構成パネルのいずれにもフォーカスがないとき有効',
	...
	ko: {
		...
		'chrome.console.scrollbackLabel': '콘솔 출력',
		'chrome.console.inputLabel': '콘솔 명령 입력',
		...
		'chrome.console.help.dialogs': '구성 / credits / 개인정보 대화상자 열기',
		...
		'chrome.console.run.openedSettings': '구성을 열었습니다.',
		...
		'chrome.hotkeys.synthTransportNote': '화면 2에서 텍스트 입력란, 메뉴, 구성 패널에 포커스가 없을 때 활성화',
