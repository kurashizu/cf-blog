...
export default {
	en: {
		...
		'chrome.privacy.section1Body': "Nothing. krsz.in has no account system, no analytics, and no tracking of any kind. Your theme, sound settings, console history and everything else this workbench remembers is written only to this browser's own local storage — it never leaves your device, and no server ever sees it.",
		'chrome.privacy.section2Title': '2. THE ONE EXCEPTION — GUESTBOOK',
		'chrome.privacy.section2Body': "A message posted in the Guestbook is sent to this site's server and displayed publicly. That form carries its own confirmation next to the send button, separate from this notice.",
	...
	'zh-CN': {
		...
		'chrome.privacy.section1Body': '什么都不收集。krsz.in 没有账户系统，没有数据分析，也没有任何形式的追踪。你的主题、声音设置、控制台历史记录，以及这个工作台记住的其他一切，都只写入这个浏览器自身的本地存储 —— 它们从不离开你的设备，也没有任何服务器会看到它们。',
		'chrome.privacy.section2Title': '2. 唯一的例外 —— 留言簿',
		'chrome.privacy.section2Body': '在留言簿中发布的消息会被发送到本站的服务器并公开显示。该表单在发送按钮旁附有自己的确认提示，与本声明分开。',
	...
	'zh-TW': {
		...
		'chrome.privacy.section1Body': '什麼都不蒐集。krsz.in 沒有帳號系統，沒有數據分析，也沒有任何形式的追蹤。你的主題、聲音設定、主控台紀錄，以及這個工作台記住的其他一切，都只寫入這個瀏覽器自身的本機儲存空間 —— 它們從不離開你的裝置，也沒有任何伺服器會看到它們。',
		'chrome.privacy.section2Title': '2. 唯一的例外 —— 留言板',
		'chrome.privacy.section2Body': '在留言板中發布的訊息會被傳送到本站的伺服器並公開顯示。該表單在傳送按鈕旁附有自己的確認提示，與本聲明分開。',
	...
	ja: {
		...
		'chrome.privacy.section1Body': '何も収集しません。krsz.in にはアカウントシステムも、アクセス解析も、いかなる追跡もありません。テーマやサウンド設定、コンソールの履歴、そのほかこのワークベンチが覚えているものはすべて、このブラウザ自身のローカルストレージにのみ書き込まれます —— あなたの端末から出ることはなく、サーバーが見ることもありません。',
		'chrome.privacy.section2Title': '2. 唯一の例外 —— ゲストブック',
		'chrome.privacy.section2Body': 'ゲストブックに投稿されたメッセージは、このサイトのサーバーに送信され、公開されます。そのフォームには送信ボタンの横に独自の確認事項があり、この通知とは別のものです。',
	...
	ko: {
		...
		'chrome.privacy.section1Body': '아무것도 수집하지 않습니다. krsz.in에는 계정 시스템도, 분석 도구도, 어떤 형태의 추적도 없습니다. 테마, 사운드 설정, 콘솔 기록 등 이 워크벤치가 기억하는 모든 것은 오직 이 브라우저 자체의 로컬 스토리지에만 저장됩니다 — 여러분의 기기를 벗어나지 않으며, 어떤 서버도 이를 확인할 수 없습니다.',
		'chrome.privacy.section2Title': '2. 유일한 예외 — 방명록',
		'chrome.privacy.section2Body': '방명록에 남긴 메시지는 이 사이트의 서버로 전송되어 공개적으로 표시됩니다. 해당 양식에는 전송 버튼 옆에 별도의 확인 문구가 있으며, 이 안내와는 별개입니다.',
