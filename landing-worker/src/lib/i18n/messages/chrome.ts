...
export default {
	en: {
		...
		'chrome.console.run.commandNotRecognized': 'Command not recognised: "{cmd}". Type "help".',
	...
	'zh-CN': {
		...
		'chrome.settings.storage.synthLayoutLabel': '合成器布局',
		'chrome.settings.storage.synthLayoutDetail': '音轨是否默认进入高级布局',
		'chrome.settings.storage.group.synth': '合成器',
		'chrome.settings.storage.group.lmSpace': 'LM SPACE',
		'chrome.settings.storage.group.vm': 'KRSZ-VM',
	...
	'zh-TW': {
		...
		'chrome.console.help.dialogs': '開啟組態 / credits / 隱私權對話框',
		...
		'chrome.console.run.openedSettings': '已開啟組態。',
		...
		'chrome.settings.storage.synthLayoutLabel': '合成器佈局',
		'chrome.settings.storage.synthLayoutDetail': '音軌是否預設進入進階佈局',
		'chrome.settings.storage.group.synth': '合成器',
		'chrome.settings.storage.group.lmSpace': 'LM SPACE',
		'chrome.settings.storage.group.vm': 'KRSZ-VM',
		...
		'chrome.tabbar.settingsTitle': '全域組態 — 聲音，以及清除本站在此瀏覽器中儲存的任何內容',
		'chrome.tabbar.cfg': 'CFG',
	...
	ja: {
		...
		'chrome.settings.storage.synthLayoutLabel': 'シンセ・レイアウト',
		'chrome.settings.storage.synthLayoutDetail': 'トラックをアドバンストレイアウトで開くかどうか',
		'chrome.settings.storage.group.synth': 'シンセ',
		'chrome.settings.storage.group.lmSpace': 'LM SPACE',
		'chrome.settings.storage.group.vm': 'KRSZ-VM',
	...
	ko: {
		...
		'chrome.settings.storage.synthLayoutLabel': '신디사이저 레이아웃',
		'chrome.settings.storage.synthLayoutDetail': '트랙을 고급 레이아웃으로 열지 여부',
		'chrome.settings.storage.group.synth': '신디사이저',
		'chrome.settings.storage.group.lmSpace': 'LM SPACE',
		'chrome.settings.storage.group.vm': 'KRSZ-VM',
