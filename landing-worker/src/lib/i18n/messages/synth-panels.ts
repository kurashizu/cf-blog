...
export default {
	en: {
		...
		'synthPanels.lane.clearHint': 'Clear this lane back to its default',
		...
		// Settings — MIDI tab
		'synthPanels.midi.deviceTitle': 'MIDI INPUT ROUTING',
		'synthPanels.midi.deviceSelector': 'Device to Track',
		'synthPanels.midi.deviceIdLabel': 'ID: {id}',
		'synthPanels.midi.playsTrack': 'PLAYS',
	...
	'zh-CN': {
		...
		'synthPanels.lane.clearHint': '清空此 lane 回到默认值',
		...
		'synthPanels.midi.deviceTitle': 'MIDI 输入路由',
		'synthPanels.midi.deviceSelector': '设备到音轨',
		'synthPanels.midi.deviceIdLabel': 'ID：{id}',
		'synthPanels.midi.playsTrack': '输出到',
	...
	'zh-TW': {
		...
		'synthPanels.lane.clearHint': '清空此 lane 回到預設值',
		...
		'synthPanels.midi.deviceTitle': 'MIDI 輸入路由',
		'synthPanels.midi.deviceSelector': '裝置到音軌',
		'synthPanels.midi.deviceIdLabel': 'ID：{id}',
		'synthPanels.midi.playsTrack': '輸出到',
	...
	ja: {
		...
		'synthPanels.lane.clearHint': 'このレーンを既定値に戻す',
		...
		'synthPanels.midi.deviceTitle': 'MIDI入力ルーティング',
		'synthPanels.midi.deviceSelector': 'デバイス→トラック',
		'synthPanels.midi.deviceIdLabel': 'ID：{id}',
		'synthPanels.midi.playsTrack': '出力先',
	...
	ko: {
		...
		'synthPanels.lane.clearHint': '이 레인을 기본값으로 되돌리기',
		...
		'synthPanels.midi.deviceTitle': 'MIDI 입력 라우팅',
		'synthPanels.midi.deviceSelector': '기기 → 트랙',
		'synthPanels.midi.deviceIdLabel': 'ID: {id}',
		'synthPanels.midi.playsTrack': '출력 대상',
