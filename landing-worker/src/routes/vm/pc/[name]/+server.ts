...
import { CHUNK, loadChunk, parseImages, parseRange, readAll, sourceVersion } from '$lib/vm-storage';
...
export const GET: RequestHandler = async ({ params, request, platform, url }) => {
	const env = platform?.env as { PC_IMAGES?: string; VM_BUCKET?: R2Bucket } | undefined;
