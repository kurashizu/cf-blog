...
export const TmuxWorkspace: React.FC = () => {
  ...
  const BUILTIN_SONGS = [
    ...
    { id: 'RICK', name: 'NEVER GONNA GIVE YOU UP', steps: 3296, bpm: 114, meter: '4/4' as TimeSignature },
  ];
  const SOUND_PRESETS = [
...
<button
                  ...
                  <div className="lg:col-span-2 border border-[#e06c75]/40 p-1.5 bg-black/60 rounded-xs flex flex-col justify-between h-full min-h-0 overflow-hidden">
                    ...
                    {activeFxTab === 'fx' ? (
                      /* Main FX View: 5 Hardware FX Knobs in Hexagonal Close Packing (最密堆积: 上3下2交错嵌套, No Divider) */
                      ...
                      <div className="flex-1 min-h-0 flex flex-col justify-between py-0.5">
                        ...
                        <div className="flex items-center justify-between px-1 pb-0.5 border-b border-white/10 shrink-0">
                          ...
                          <button
                            ...
                            className={`px-2 py-0.2 text-[9px] rounded-xs border font-black cursor-pointer transition-all ${
                              isEqEnabled
